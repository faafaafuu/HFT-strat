...
- Modules analyzed: 109
- Internal import edges: 282
- Package dependency edges: 89
...
|---|---:|---:|---:|---:|---:|
| `app.config` | 428 | 26 | 14 | 38 | 0 |
| `app.data.database` | 240 | 1 | 9 | 26 | 1 |
